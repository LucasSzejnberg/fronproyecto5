...
import Rectangulo1 from '../components/Rectangulo1'; // Asegúrate de que esta ruta sea correcta
import '../components/RequestTurnos1.css';
import "./GetTurnos.css"
interface Turno {
  _id: string;
  paciente: string;
  medico: string;
...
interface GetTurnosProps {
  searchTerm: string;
}

const GetTurnos: React.FC<GetTurnosProps> = ({ searchTerm }) => {
  ...
  return (
    <div className="request-turnos-container-new">
